...
// 會自動上下升降的 Board
class AutoBoard : public Object {
public:
    explicit AutoBoard(const std::string& ImagePath, glm::vec2 position, glm::vec2 size);
    void AddCurrNumber(std::shared_ptr<Character>& character) override { curr_number.push_back(character); }
    void Move() override;
    std::string GetType() override { return "AutoBoard"; }
    void ResetCurrNumber() override { curr_number.clear(); }
...
// 會自動左右升降的 Board
class AutoBoard1 : public Object {
public:
    explicit AutoBoard1(const std::string& ImagePath, glm::vec2 position, glm::vec2 size);
    void AddCurrNumber(std::shared_ptr<Character>& character) override { curr_number.push_back(character); }
    void Move() override;
    std::string GetType() override { return "AutoBoard1"; }
    void ResetCurrNumber() override { curr_number.clear(); }
...
// 會上下升降的 Board1
class Board1 : public Object {
public:
    explicit Board1(const std::string& ImagePath, glm::vec2 position, glm::vec2 size);
    void AddCurrNumber(std::shared_ptr<Character>& character) override { curr_number.push_back(character); }
    void Move() override;
    std::string GetType() override { return "Board1"; }
    void ResetCurrNumber() override { curr_number.clear(); }
